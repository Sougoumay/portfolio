...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{asset("assets/backend/images/icon/favicon.ico")}}">
...
<div class="page-container">
    ...
    <div class="sidebar-menu">
        <div class="sidebar-header">
            <div class="logo">
                <a href="index.html"><img src="{{asset("assets/backend/images/icon/logo.png")}}" alt="logo"></a>
            </div>
        </div>
        <div class="main-menu">
            <div class="menu-inner">
                <nav>
                    <ul class="metismenu" id="menu">
                        <li><a href="maps.html"><i class="ti-map-alt"></i> <span>Dashboard</span></a></li>
                        <li><a href="{{route("admin.formation.index")}}">
                        ...
                        <li><a href="invoice.html"><i class="ti-receipt"></i> <span>Compétences</span></a></li>
                        <li><a href="invoice.html"><i class="ti-receipt"></i> <span>Expériences</span></a></li>
                        <li><a href="invoice.html"><i class="ti-receipt"></i> <span>Projets</span></a></li>
                    </ul>
                </nav>
            </div>
        </div>
                                ...
                                <div class="nofity-list">
                                    <a href="#" class="notify-item">
                                        <div class="notify-thumb">
                                            <img src="{{asset("assets/backend/images/author/author-img1.jpg")}}" alt="image">
                                        </div>
                                        <div class="notify-text">
                                            <p>Aglae Mayer</p>
                                    ...
                                    <a href="#" class="notify-item">
                                        <div class="notify-thumb">
                                            <img src="{{asset("assets/backend/images/author/author-img2.jpg")}}" alt="image">
                                        </div>
                                        <div class="notify-text">
                                            <p>Aglae Mayer</p>
                                    ...
                                    <a href="#" class="notify-item">
                                        <div class="notify-thumb">
                                            <img src="{{asset("assets/backend/images/author/author-img3.jpg")}}" alt="image">
                                        </div>
                                        <div class="notify-text">
                                            <p>Aglae Mayer</p>
                                    ...
                                    <a href="#" class="notify-item">
                                        <div class="notify-thumb">
                                            <img src="{{asset("assets/backend/images/author/author-img4.jpg")}}" alt="image">
                                        </div>
                                        <div class="notify-text">
                                            <p>Aglae Mayer</p>
